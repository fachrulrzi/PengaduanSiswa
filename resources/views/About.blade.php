...
<div class="row">
    <div class="col-12 mb-4">
        <img src="{{ asset('img/323136986_1350746869029405_5568785056163240281_n.jpg') }}" class="d-block rounded-3" height="600" width="100%"
                  alt="...">
    </div>
    <div class="col-12">
            <Article>
                <h1 class="fw-bold mb-2">Pengaduan Siswa SMK Telkom</h1>
